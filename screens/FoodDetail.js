                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
                            ...
                            <Text style={{ color: COLORS.gray, ...FONTS.body3 }}>Chillox</Text>
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        ...
                        Who doesn't love a big, tender, juicy steakhouse burger? These stacked beef burgers are a BBQ favourite & are really easy-to-make.
                        </Text>
                    </View>
                </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => { console.log("Order on pressed") }}
                        >
                            <LinearGradient
